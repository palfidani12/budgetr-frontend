...
export const Insights = () => {
  ...
  return (
    <div className={classes.insightsCard}>
      ...
      <div className={classes.insightsSubtitle}>Visualize your {selectedTab.toLowerCase()} breakdown</div>
      <div className={classes.insightsTabs}>
        {TABS.map((tab) => (
          <button
            key={tab}
            className={classes.insightsTab + (selectedTab === tab ? ' ' + classes.activeTab : '')}
      ...
      <div className={classes.pieChartPlaceholder}>
        ...
        >
          ...
          />
          <path
            d='M60 60 L110 60 A50 50 0 1 1 60 10 Z'
            fill='#22c55e'
          />
        </svg>
